...
function init_echarts() {
    if ("undefined" != typeof echarts) {
        ...
        var a = {
            color: ["#26B99A", "#34495E", "#c685f2", "#3498DB", "#9B59B6", "#8abb6f", "#759c6a", "#bfd3b7"],
            title: {
                itemGap: 8,
                textStyle: {
                    fontWeight: "normal",
        ...
        if ($("#echart_line").length) {
            ...
            f.setOption({
                ...
                legend: {
                    x: 220,
                    y: 40,
                    data: ["Филиалы", "Контакт-центры", "Техподдержки"]
                },
                toolbox: {
                    show: !0,
                    feature: {
        ...
        if ($("#echart_pie").length) {
            ...
            j.setOption({
                ...
                legend: {
                    x: "center",
                    y: "bottom",
                    data: ["Нейтралы", "Детракторы",  "Промоутеры"]
                },
                toolbox: {
                    show: !0,
                    feature: {
