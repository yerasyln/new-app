...
<!-- Filtr end-->
    ...
    <div class="row tile_count">
        ...
        <div class="col-sm-2 tile_stats_count" style="width: 14%;">
            ...
            <div class="count"><?php  echo isset($call_center_nps['call-center']['rate'])? $call_center_nps['call-center']['rate']:"0%";  ?></div>
            <span class="count_bottom"><i  <?php if(isset($call_center_nps['call-center']['rate']) && $call_center_nps['call-center']['rate']<$call_center_nps['call-center']['rate']):   ?> class="red" <?php else: ?>  class="green" <?php endif; ?>  ><i
                     <?php if(isset($call_center_nps['call-center']['rate']) &&  $call_center_nps['call-center']['rate']<$call_center_nps['call-center']['rate']):   ?>  class="fa fa-sort-desc"    <?php else: ?>  class="fa fa-sort-asc"  <?php endif; ?>   ></i><?php  echo isset($call_center_nps['call-center']['rate'])? $ConnectionDot_arr_lastweek['call-center']['rate']:"";  ?> </i> На прошлой неделе</span>
        </div>
		 <div class="col-sm-2 tile_stats_count"  style="width: 14%;">
            <span class="count_top"><i class="fa fa-user"></i> NPS офис продаж</span>
            <div class="count"><?php  echo isset($office_nps['office']['rate'])? $office_nps['office']['rate']:"0%";  ?></div>
<?php  if(!empty($office_nps['office'])): ?>
            <span class="count_bottom"><i <?php if($office_nps['office']['rate']<$office_nps['office']['rate']):   ?> class="red" <?php else: ?>  class="green" <?php endif; ?>></i>
<?php else: ?>
  <span class="count_bottom"><i class="green"></i></span>
<?php endif; ?>

<?php  if(!empty($ConnectionDot_arr['office'])): ?>
              <span class="count_bottom">  <i  <?php if($ConnectionDot_arr['office']['rate']<$ConnectionDot_arr_lastweek['office']['rate']):   ?>   class="fa fa-sort-desc"   <?php else: ?>     class="fa fa-sort-asc"  <?php endif; ?>  ></i><?php  echo isset($call_center_nps['office']['rate'])? $ConnectionDot_arr_lastweek['office']['rate']:"";  ?>  </i>На прошлой неделе</span>
<?php else: ?>
                <span class="count_bottom">  <i  class="fa fa-sort-asc"    ></i><?php  echo "";  ?>  </i>На прошлой неделе</span>
<?php endif; ?>
        </div>
        <div class="col-sm-2 tile_stats_count" style="width: 14%;">
            <span class="count_top"><i class="fa fa-user"></i> NPS техподдержки</span>
            <div class="count"><?php  echo isset($help_desk_nps['help_desk']['rate'])? $help_desk_nps['help_desk']['rate']:"0%";  ?></div>
            <span class="count_bottom">
            <?php if(!empty($help_desk_nps['help_desk'])): ?>
            <i <?php if($help_desk_nps['help_desk']['rate']<$help_desk_nps['help_desk']['rate']):   ?> class="red" <?php else: ?>  class="green" <?php endif; ?>></i>
            <?php else: ?>
              <i    class="green" ></i>
            <?php endif; ?>
</span>

  <?php if(!empty($ConnectionDot_arr['help_desk'])): ?>
                <i <?php if($ConnectionDot_arr['help_desk']['rate']<$ConnectionDot_arr_lastweek['help_desk']['rate']):   ?>        class="fa fa-sort-desc"   <?php else: ?> class="fa fa-sort-asc"   <?php endif; ?>      ></i><?php  echo isset($ConnectionDot_arr_lastweek['help_desk']['rate'])? $ConnectionDot_arr_lastweek['help_desk']['rate']:"";  ?> </i>На прошлой неделе</span>
  <?php else: ?>
                    <i   class="fa fa-sort-desc"           ></i> </i>На прошлой неделе</span>
  <?php endif; ?>
