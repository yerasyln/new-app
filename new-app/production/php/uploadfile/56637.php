...
<input type="number"  placeholder="с" class="form-control" value="<?php echo $_GET['duration_of_serviceStart'];?>" name="duration_of_serviceStart"/>
<?php else:?>
<input type="number"  placeholder="с" class="form-control" name="duration_of_serviceStart"/>
<?php endif;?>
<br>
<?php if(isset($_GET['duration_of_serviceEnd'])):?>
<input type="number"  placeholder="с" class="form-control" value="<?php echo $_GET['duration_of_serviceEnd'];?>" name="duration_of_serviceEnd"/>
<?php else:?>
<input type="number" placeholder="по" class="form-control" name="duration_of_serviceEnd"/>
<?php endif;?>
</div>
                <div class="col-md-2 col-sm-12 col-xs-12 form-group"> 
<label>Жизнь клиента <br>(мес):</label>
<?php if(isset($_GET['servicetimeStart'])):?>
<input type="number"  placeholder="с" class="form-control" value="<?php echo $_GET['servicetimeStart'];?>" name="servicetimeStart"/>
<?php else:?>
<input type="number"  placeholder="с" class="form-control" name="servicetimeStart"/>
<?php endif;?>
<br>
<?php if(isset($_GET['servicetimeEnd'])):?>
<input type="number"  placeholder="с" class="form-control" value="<?php echo $_GET['servicetimeEnd'];?>" name="servicetimeEnd"/>
<?php else:?>
<input type="number" placeholder="по" class="form-control" name="servicetimeEnd"/>
<?php endif;?>
</div> 
...
<input type="number"  placeholder="с" class="form-control" value="<?php echo $_GET['transactionsStart'];?>" name="transactionsStart"/>
<?php else:?>
<input type="number"  placeholder="с" class="form-control" name="transactionsStart"/>
<?php endif;?>
<br>
<?php if(isset($_GET['transactionsEnd'])):?>
<input type="number"  placeholder="с" class="form-control" value="<?php echo $_GET['transactionsEnd'];?>" name="transactionsEnd"/>

<?php else:?>
<input type="number" placeholder="по" class="form-control" name="transactionsEnd"/>
...
<input type="number"  placeholder="с" class="form-control" value="<?php echo $_GET['ageStart'];?>" name="ageStart"/>
<?php else:?>
<input type="number"  placeholder="с" class="form-control" name="ageStart"/>
<?php endif;?>
<br>
<?php if(isset($_GET['ageEnd'])):?>
<input type="number"  placeholder="с" class="form-control" value="<?php echo $_GET['ageEnd'];?>" name="ageEnd"/>
<?php else:?>
<input type="number" placeholder="по" class="form-control" name="ageEnd"/>
<?php endif;?>
</div>
...
<!-- Filtr end-->
            ...
            <div class="col-md-15 col-sm-3">
                <div class="tile-stats">
                    ...
                    <div class="count"><?php echo !empty($total_question[1]['col_count'])? $total_question[1]['col_count']:""; ?></div>
                    <p>
            ...
            <div class="col-md-15 col-sm-3 ">
                <div class="tile-stats">
                    ...
                    <div class="count"><?php echo  !empty($total_question[2]['col_count'])? $total_question[2]['col_count']:""; ?></div>
                    <p>
            ...
            <div class="col-md-15 col-sm-3 ">
                <div class="tile-stats">
                    ...
                    <div class="count"><?php echo !empty($total_question[3]['col_count'])? $total_question[3]['col_count']:""; ?></div>
                    <p>
            ...
            <div class="col-md-15 col-sm-3 ">
                <div class="tile-stats">
                    ...
                    <div class="count"><?php echo !empty($total_question[4]['col_count'])?$total_question[4]['col_count']:""; ?></div>
                    <p>
            ...
            <div class="col-md-15 col-sm-3 ">
                <div class="tile-stats">
                    ...
                    <div class="count"><?php echo !empty($total_question[5]['col_count']) ?$total_question[5]['col_count']:""; ?></div>
                    <p>
                        <a href="../production/questionDataView.php?question=5" target="_blank" ><b>(<?php echo !empty($total_question[5]['title'])?$total_question[5]['title']:""; ?>)</b></a>
                    </p>
    ...
    <div class="row tile_count">
        <div class="col-sm-2 tile_stats_count" style="width: 14%;">
            <span class="count_top"><i class="fa fa-user"></i> Общий CSAT</span>
            <div class="count" ><?php echo isset($totalCSAT[0]['arif'])? $totalCSAT[0]['arif']:"";  ?> </div>
            <span class="count_bottom"><i <?php if($totalCSAT[0]['change_status']!=0): ?> class="red" <?php else: ?> class="green"  <?php endif; ?>   >
                    <i
                      <?php if($totalCSAT[0]['change_status']!=0): ?>  class="fa fa-sort-desc" <?php else: ?>  class="fa fa-sort-asc" <?php endif; ?>  ></i>
        ...
        <div class="col-sm-2 tile_stats_count" style="width: 14%;">
            ...
            <span class="count_bottom"><i  <?php if($changeStatusForAllAsked!=0): ?> class="red" <?php else: ?> class="green"  <?php endif; ?> ><i
                      <?php if($changeStatusForAllAsked!=0): ?>  class="fa fa-sort-desc" <?php else: ?> class="fa fa-sort-asc"  <?php endif; ?> ></i><?php echo isset($Allaskedpeople_lastweek[0]['all_asked'])? $Allaskedpeople_lastweek[0]['all_asked']:"" ?> </i>  На прошлой неделе</span>
        </div>
        <div class="col-sm-2 tile_stats_count" style="width: 14%;">
            ...
            <span class="count_bottom"><i <?php if($changeStatusTotalRespondRate!=0): ?> class="red" <?php else: ?> class="green"  <?php endif; ?>><i
                     <?php if($changeStatusTotalRespondRate!=0): ?>   class="fa fa-sort-desc" <?php else: ?>   class="fa fa-sort-asc"  <?php endif; ?> ></i><?php echo isset($totalRespondrate_lastweek)? $totalRespondrate_lastweek:"" ?> </i> На прошлой неделе</span>
        </div>
        <div class="col-sm-2 tile_stats_count" style="width: 14%;">
            <span class="count_top"><i class="fa fa-user"></i>  NPS call-center</span>
            <div class="count"><?php  echo isset($ConnectionDot_arr['call-center']['rate'])? $ConnectionDot_arr['call-center']['rate']:"0%";  ?></div>
            <span class="count_bottom"><i  <?php if($ConnectionDot_arr['call-center']['rate']<$ConnectionDot_arr_lastweek['call-center']['rate']):   ?> class="red" <?php else: ?>  class="green" <?php endif; ?>  ><i
                     <?php if($ConnectionDot_arr['call-center']['rate']<$ConnectionDot_arr_lastweek['call-center']['rate']):   ?>  class="fa fa-sort-desc"    <?php else: ?>  class="fa fa-sort-asc"  <?php endif; ?>   ></i><?php  echo isset($ConnectionDot_arr_lastweek['call-center']['rate'])? $ConnectionDot_arr_lastweek['call-center']['rate']:"";  ?> </i> На прошлой неделе</span>
        </div>
		 <div class="col-sm-2 tile_stats_count"  style="width: 14%;">
            <span class="count_top"><i class="fa fa-user"></i> NPS офис продаж</span>
            <div class="count"><?php  echo isset($ConnectionDot_arr['office']['rate'])? $ConnectionDot_arr['office']['rate']:"0%";  ?></div>
            <span class="count_bottom"><i <?php if($ConnectionDot_arr['office']['rate']<$ConnectionDot_arr_lastweek['office']['rate']):   ?> class="red" <?php else: ?>  class="green" <?php endif; ?>><i
                <?php if($ConnectionDot_arr['office']['rate']<$ConnectionDot_arr_lastweek['office']['rate']):   ?>   class="fa fa-sort-desc"   <?php else: ?>     class="fa fa-sort-asc"  <?php endif; ?>  ></i><?php  echo isset($ConnectionDot_arr_lastweek['office']['rate'])? $ConnectionDot_arr_lastweek['office']['rate']:"";  ?>  </i>На прошлой неделе</span>
        </div>
        <div class="col-sm-2 tile_stats_count" style="width: 14%;">
            <span class="count_top"><i class="fa fa-user"></i> NPS техподдержки</span>
            <div class="count"><?php  echo isset($ConnectionDot_arr['help_desk']['rate'])? $ConnectionDot_arr['help_desk']['rate']:"0%";  ?></div>
            <span class="count_bottom"><i <?php if($ConnectionDot_arr['help_desk']['rate']<$ConnectionDot_arr_lastweek['help_desk']['rate']):   ?> class="red" <?php else: ?>  class="green" <?php endif; ?>><i
                <?php if($ConnectionDot_arr['help_desk']['rate']<$ConnectionDot_arr_lastweek['help_desk']['rate']):   ?>        class="fa fa-sort-desc"   <?php else: ?> class="fa fa-sort-asc"   <?php endif; ?>      ></i><?php  echo isset($ConnectionDot_arr_lastweek['help_desk']['rate'])? $ConnectionDot_arr_lastweek['help_desk']['rate']:"";  ?> </i>На прошлой неделе</span>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content2">
                    ...
                    <div   id="graph_donut" style=" height: 319px;"></div>
      ...
      <li>
                            <h5 class="text-muted">
                                <i class="fa fa-circle" style="color: #34495E;"></i> <?php echo $result_data_bad['label'] ?></h5>
                    ...
                    <ul class="list-inline m-t-30 text-center">
                        ...
                        <li>
                            ...
                            <h4 class="m-b-0"> <?php echo $result_data_totall['total'] ?></h4>
                        </li>
                    </ul>
                    ...
                    <div style="display:none">
                        <div id="echart_line_table" >
                            <table class="countries_list">
                                ...
                                <tr>
                                    <td><?php echo !empty($result_data_bad['value'])? $result_data_bad['value']: ""; ?></td>
                                    <td><?php echo !empty($result_data_good['value'])? $result_data_good['value']:"";  ?></td>
                                    <td><?php echo !empty($result_data_well['value'])? $result_data_well['value']: "";  ?></td>
                                </tr>
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content2">
             <div style="width: 100%; height: 442px; background-color: #FFFFFF;" >
                  ...
                  <div class="progress" >
                        ...
                        <div class="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="50" style="width: <?php echo  abs($bar_data['rate'])."px";  ?>;">
...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <footer style="margin-left: 0px;">
		...
		<a href="https://seal.beyondsecurity.com/vulnerability-scanner-verification/clientsurvey.kz"><img src="https://seal.beyondsecurity.com/verification-images/clientsurvey.kz/vulnerability-scanner-2.gif" alt="Website Security Test" border="0" /></a>
...
$(function() {
    ...
    for( var i in map ) {
	    if (map.hasOwnProperty(i)){
			...
			if(map[i]['number']){
				new_map.push(parseFloat(map[i]['number']));
			}    
...
var exportToExcel = (function() {
  var uri = 'data:application/vnd.ms-excel;base64,'
    , template = '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="http://www.w3.org/TR/REC-html40"><head><?xml version="1.0" encoding="UTF-8" standalone="yes"?><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name></x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml></head><body><table>{table}</table></body></html>'
