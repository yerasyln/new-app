...
SELECT product_stages.id,product_stages.name,product_stages.code,product_stages.product_id FROM product INNER JOIN product_stages ON product.id = product_stages.product_id";
	...
	if($resultsProductStages ->num_rows > 0){
		 while($row = $resultsProductStages->fetch_assoc()){
		 	$resultsProductStageData[$row['id']] = $row;
		 }
	}
	
	$sqlSimpleQuestions = "select * from simple_questions INNER JOIN product on simple_questions.company_id =product.company_id;";
	$resultsSimpleQuestions = $conn -> query($sqlSimpleQuestions);
	$resultsSimpleQuestionData = array();
	if($resultsSimpleQuestions ->num_rows>0){
		while($row = $resultsSimpleQuestions->fetch_assoc()){
			$resultsSimpleQuestionData[$row['id']]=$row;
		}
	}
			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
                     ...
                     <a href="index.php" class="site_title">&nbsp; <img src="images/LogoDMSlog.png"  height="50%" width="40%"></a>
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> Главная <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="index.php">Индикаторы</a></li>
										<!--<li><a href="askQuestions.php">Опросы револьверных вопросов</a></li>
										<li><a href="askSimpleQuestions.php">Опросы </a></li>
										<li><a href="randomQuestions.php">Рандом опросы </a></li>-->
				...
				<div class="nav_menu">
					<nav>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<a href="javascript:;"
								...
								aria-expanded="false">
								 <img src="images/user.png" alt=""><?php echo $lastname." ".$firstname;?>
								<span class=" fa fa-angle-down"></span>
							</a>
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a href="profile.php?user_id=<?php echo $id;?>"> Личные данные</a></li>
									<!--<li><a href="javascript:;"> <span
											class="badge bg-red pull-right">50%</span> <span>Настройки</span>
									</a></li>-->
									<li><a href="helpDesk.php">Служба поддержки</a></li>
							...
							<a href="javascript:;"
								...
								aria-expanded="false"> <i class="fa fa-envelope-o"></i> <span
									class="badge bg-green"><?php echo $count; ?></span>
							</a>
						<ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">

                    <?php
                    $i = 0;
                    foreach ($resultChatData as $chatData):?>
                     <?php if(++$i > 3) break;?>
                      ...
                      <a>
                        ...
                        <span>
                          <span><?php echo 'Администратор';?></span>

                        </span>
                        <span class="message">
                          <?php echo substr($chatData['reply_message'],0,210)."...";?>
                        </span>
                        <span> <a href="inbox.php?id=<?php echo $chatData['id'];?>">Подробно... </span>
                      </a>
                         <span class="time"><?php echo $chatData['create_at'];?></span>
                    </li>
                    <?php endif;?>
                    <?php endforeach;?>
                    ...
                    <li>
                      <div class="text-center">
                        <a>
                            <strong><a href="inbox.php">Посмотреть все</a></strong>
