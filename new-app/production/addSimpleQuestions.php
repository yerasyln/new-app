                  ...
                  <div class="x_content">
					...
					<div class="alert alert-danger" id="error" style="display:none"  >
					  <strong>Danger!</strong> Indicates a dangerous or potentially negative action.
                       ...
                       <button type="button"  id="sending" class="btn btn-round btn-primary" onclick="send()">Сохранить</button>
...
//$('.dt-buttons').html(button);
   ...
   function send(){
	 ...
	 var question  =  $('#editor-one').text();  
	$('#loading').css('display','block');	
	$('#sending').css('display','none');

	
		$.post("php/addSimpleQuestions.php",
    		    {
    		    ...
    		    function(data, status){
        		 if(data==true){
						...
						$('#editor-one').load(location.href+" #loading_page>*","");
