...
require 'php/getAllQuestions.php';
require 'php/db.php';
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Отправка револьверных вопросов смс</h3>
              </div>
                    ...
                    <table id="datatable-buttons1" class="table table-striped table-bordered">
                      ...
                      <?php  foreach($result_data as $data): ?>
                        <tr>
                          ...
                          <td><?php if($data['status']==0): ?><div style="font-size:14px;"><span class="label label-info">Не отправлен</span></div><?php else:  ?><div style="font-size:14px;" ><span class="label label-success">Отправлен<?php endif;  ?></span></div></td>
					    <td><input type="radio"  class="form-radio-input" name="questions[]"  id="questions[]"  value="<?php echo $data['id']; ?>" /></td> 
