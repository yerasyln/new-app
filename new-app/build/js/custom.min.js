...
function getParameterByName(name, url) {
    ...
    function sendingData_reportrange_nps_question(start, end){
        var question_id = getParameterByName('question');
         ...
         $.post("php/respond_rate_questions.php", {start: start, end: end, question_id: question_id}, function (data) {
...
function sendingDataCsat(start, end) {
    ...
    $.post("php/csatGetData.php", {start: start, end: end}, function (data) {
...
function sendingDataCsatResponse(start, end) {
    ...
    $.post("php/csat_response_rate.php", {start: start, end: end}, function (data) {
