...
function sendingData(start, end) {

var getParam = JSON.stringify(getData);
   // alert(getParam);

    $.post("php/areaAmcharts.php", {start: start, end: end, getParam: getParam}, function (data) {
       ...
       var table="<table class='table' style='display: none;'><tr><th>Date</th><th>Call-center</th><th>Офис продаж</th><th>Техподдержка</th></tr>";
      ...
      // var arr = JSON.parse(data);
       ...
       for (var property in arr) {
       	  ...
       	  table+="<tr>";
       	  table+="<td>";
       	  	table+=  JSON.stringify(arr[property]["date"]);
       	  table+="</td>";
       	  table+="<td>";
     	  	  	table+=JSON.stringify(arr[property]["column-1"]);
     	      table+="</td>";
     	      table+="<td>";
     	      	table+=JSON.stringify(arr[property]["column-2"]);
             table+="</td>";
             table+="<td>";
   	      	table+=JSON.stringify(arr[property]["column-3"]);
           table+="</td>";
       	  table+="</tr>";
       	 // output = property + ': ' + +'; ';
         ...
         $('#chartdiv1_poi_export').html(table);
...
function sendingData_reportrange_nps_poi(start, end){


	var getParam = JSON.stringify(getData);

    $.post("php/poi_nps_ref.php", {start: start, end: end, getParam: getParam}, function (data) {


   var table="<table class='table' style='display: none;'><tr><th>Date</th><th>Детракторы</th><th>Нейтралы</th><th>Промоутеры</th></tr>";
   ...
   for (var property in arr) {
     ...
     $('#poi_nps_export').html(table);



       AmCharts.makeChart("poi_nps",
				{
					"type": "serial",
					"categoryField": "date",
					"dataDateFormat": "YYYY-MM-DD",
					...
					"valueAxes": [
						{
							"id": "ValueAxis-1",
							"title": "Динамика NPS точки контакта"
						}
					],
					"allLabels": [],
					"balloon": {},
...
function reportrange_nps_poi(){

	 var start = moment().subtract(29, 'days');
	    var end = moment();

	    function cb_reportrange_nps_poi(start, end) {
	        $('#reportrange_nps_poi span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

	        sendingData_reportrange_nps_poi(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'))

	    }

	    $('#reportrange_nps_poi').daterangepicker({
	        startDate: start,
	        endDate: end,
	        ranges: {
	    ...
	    }, cb_reportrange_nps_poi);

	    cb_reportrange_nps_poi(start, end);
...
function init_daterangepicker() {
    ...
    function cb(start, end) {
        ...
        sendingData(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'))
...
function  sendingDataNPS (start, end){

    //console.log(start);
    var getParam = JSON.stringify(getData);

     $.post("php/handleNPSReq.php", {start: start, end: end, getParam: getParam}, function (data) {
    ...
    for (var property in arr) {
    	  ...
    	  table+="</td>";
    	  table+="<td>";
  	  	  	table+=JSON.stringify(arr[property]["bad"]);
  	      table+="</td>";
  	      table+="<td>";
  	      	table+=JSON.stringify(arr[property]["good"]);
          table+="</td>";
          table+="<td>";
	      	table+=JSON.stringify(arr[property]["well"]);
        table+="</td>";
    	  table+="</tr>";
    	 // output = property + ': ' + +'; ';
      ...
      $('#chartdiv1_nps_export').html(table);



        AmCharts.makeChart("chartdiv1_nps",
				{
					"type": "serial",
...
function sendingDataNPS_average(start, end){

    var getParam = JSON.stringify(getData);

    $.post("php/getQuestions.php", {start: start, end: end, getParam: getParam}, function (data) {
   ...
   for (var property in arr) {
     ...
     $('#average_nps_export').html(table);



       AmCharts.makeChart("average",
				{
					"type": "serial",
					"categoryField": "date",
					"dataDateFormat": "YYYY-MM-DD",
...
function reportrange_nps_average(){

    var start = moment().subtract(29, 'days');
    var end = moment();

    function cb_reportrange_nps_average(start, end) {
        $('#reportrange_nps_average span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

        sendingDataNPS_average(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'))

    }

    $('#reportrange_nps_average').daterangepicker({
        startDate: start,
        endDate: end,
        ranges: {
           'Cегодня': [moment(), moment()],
    ...
    }, cb_reportrange_nps_average );

    cb_reportrange_nps_average(start, end);
...
function init_daterangepicker_nps() {

    var start = moment().subtract(29, 'days');
    var end = moment();

    function cb(start, end) {
        $('#reportrange_nps span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

        sendingDataNPS(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'))

    }

    $('#reportrange_nps').daterangepicker({
        startDate: start,
        endDate: end,
        ranges: {
           'Cегодня': [moment(), moment()],
...
function getParameterByName(name, url) {
    ...
    function sendingData_reportrange_nps_question(start, end){
        var question_id = getParameterByName('question');

        var getParam = JSON.stringify(getData);

         $.post("php/respond_rate_questions.php", {start: start, end: end, question_id: question_id, getParam: getParam}, function (data) {
       ...
       var table="<table class='table' style='display: none;'><tr><th>Date</th><th>Количество опрошенных</th><th>Количество ответов</th><th>Response rate %</th></tr>";
       ...
       for (var property in arr) {
         ...
         $('#respond_rate_question_export').html(table);
        ...
        AmCharts.makeChart("respond_rate_question",
				{
					"type": "serial",
					"categoryField": "date",
					"dataDateFormat": "YYYY-MM-DD",
  ...
  function cb_reportrange_nps_question(start, end) {
        $('#reportrange_nps_question span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

        sendingData_reportrange_nps_question(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'))

    }



function response_nps_question(){
    ...
    $('#reportrange_nps_question').daterangepicker({
        startDate: start,
        endDate: end,
        ranges: {
           'Cегодня': [moment(), moment()],
    ...
    }, cb_reportrange_nps_question);

    cb_reportrange_nps_question(start, end);
...
function sendingDataCsat(start, end) {

  var getParam = JSON.stringify(getData);



    $.post("php/csatGetData.php", {start: start, end: end, getParam:getParam}, function (data) {
...
function cbzz(start, end) {

	$('#reportrange_csat span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

    sendingDataCsat(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'))

}

function init_daterangepicker_csat() {
    ...
    $('#reportrange_csat').daterangepicker({
        startDate: start,
        endDate: end,
        ranges: {
           'Cегодня': [moment(), moment()],
    ...
    cbzz(start, end);
     ...
     response_nps_question();


      response_nps_region();

      response_csat_region();
	...
	function sendingDatareportrange_CSAT_region(start, end){

		   var region_id = getParameterByName('reqion_id');

    $.post("php/detailedRegionData.php", {start: start, end: end, region_id: region_id}, function (data) {
    	  ...
    	  var arr = data!=''?  JSON.parse(data): {};
			...
			var table="<table class='table' style='display: none;'><tr><th>Date</th><th>очень не удовлетворен</th><th>не удовлетворен</th><th>не знаю</th><th>удовлетворен</th><th>очень удовлетворен</th></tr>";
		    ...
		    for (var property in arr) {
		    	  ...
		    	  table+="</td>";
		    	  table+="<td>";
		  	  	  	table+=JSON.stringify(arr[property]["very_bad"]);
		  	      table+="</td>";
		  	      table+="<td>";
		  	      	table+=JSON.stringify(arr[property]["bad"]);
		          table+="</td>";
		          table+="<td>";
			      	table+=JSON.stringify(arr[property]["dont_know"]);
		        table+="</td>";
		        table+="<td>";
		      		table+=JSON.stringify(arr[property]["good"]);
		      	table+="</td>";
		      	table+="<td>";
		      		table+=JSON.stringify(arr[property]["very_good"]);
		      	table+="</td>";
		    	  table+="</tr>";
		    	 // output = property + ': ' + +'; ';
		      ...
		      $('#char_CSAT_region_export').html(table);




			 AmCharts.makeChart("char_CSAT_region",
						{
							"type": "serial",
							"categoryField": "date",
							"dataDateFormat": "YYYY-MM-DD",
...
"valueField": "very_good"
	...
	function cbzz_reportrange_CSAT_region(start, end){

		$('#reportrange_CSAT_region span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

	    sendingDatareportrange_CSAT_region(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'))
  ...
  function response_csat_region (){


	    var start = moment().subtract(29, 'days');
	    var end = moment();

	    $('#reportrange_CSAT_region').daterangepicker({
	        startDate: start,
	        endDate: end,
	        ranges: {
	           'Cегодня': [moment(), moment()],
	    ...
	    }, cbzz_reportrange_CSAT_region);

	    cbzz_reportrange_CSAT_region(start, end);
...
function sendingDataReportrange_NPS_region(start, end){

     var region_id = getParameterByName('reqion_id');

      $.post("php/NPS_dynamic_region.php", {start: start, end: end, region_id: region_id}, function (data) {
    	  ...
    	  var arr = data!=''?  JSON.parse(data): {};
		    ...
		    for (var property in arr) {
		    	  ...
		    	  table+="</td>";
		    	  table+="<td>";
		  	  	  	table+= Number((arr[property]["bad"])) ;
		  	      table+="</td>";
		  	      table+="<td>";
		  	      	table+=Number(arr[property]["good"]);
		          table+="</td>";
		          table+="<td>";
			      	table+=Number(arr[property]["well"]);
		        table+="</td>";
		    	  table+="</tr>";
		    	 // output = property + ': ' + +'; ';
		      ...
		      $('#nps_dynamic_rep_export').html(table);
			 ...
			 AmCharts.makeChart("nps_dynamic_rep",
						{
							"type": "serial",
							"categoryField": "date",
							"dataDateFormat": "YYYY-MM-DD",
...
function cbzz_reportrange_NPS_region(start, end) {

	$('#reportrange_NPS_region span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

    sendingDataReportrange_NPS_region(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'))

}



function response_nps_region(){
    ...
    $('#reportrange_NPS_region').daterangepicker({
        startDate: start,
        endDate: end,
        ranges: {
           'Cегодня': [moment(), moment()],
    ...
    }, cbzz_reportrange_NPS_region);

    cbzz_reportrange_NPS_region(start, end);
...
function sendingData_nps_detail(start, end){



    $.post("php/nps_response_rate.php", {start: start, end: end}, function (data) {
		  ...
		  //  var arr = JSON.parse(data);
		    ...
		    for (var property in arr) {
		      ...
		      $('#chart_nps_response_rate_export').html(table);



			 AmCharts.makeChart("chart_nps_response_rate",
						{
							"type": "serial",
							"categoryField": "date",
							"dataDateFormat": "YYYY-MM-DD",
...
function cbzz_reportrange_nps_detail(start, end) {

	$('#reportrange_nps_detail span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

    sendingData_nps_detail(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'))

}



function response_nps_detail(){
    ...
    $('#reportrange_nps_detail').daterangepicker({
        startDate: start,
        endDate: end,
        ranges: {
           'Cегодня': [moment(), moment()],
    ...
    }, cbzz_reportrange_nps_detail);

    cbzz_reportrange_nps_detail(start, end);
...
function sendingDataCsatResponse(start, end) {

  var getParam = JSON.stringify(getData);

    $.post("php/csat_response_rate.php", {start: start, getParam:getParam, end: end}, function (data) {
			...
			var table="<table class='table' style='display: none;'><tr><th>Date</th><th>Количество опрошенных</th><th>Количество ответов</th><th>Respond rate</th></tr>";
		  ...
		  //  var arr = JSON.parse(data);
		    ...
		    for (var property in arr) {
		      ...
		      $('#chart_csat_response_rate_export').html(table);




			 AmCharts.makeChart("chart_csat_response_rate",
						{
							"type": "serial",
							"categoryField": "date",
							"dataDateFormat": "YYYY-MM-DD",
...
function cb_response_csat(start, end) {

    $('#reportrange_csat_response span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));

    sendingDataCsatResponse(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'))
 ...
 function response(){
    ...
    $('#reportrange_csat_response').daterangepicker({
        startDate: start,
        endDate: end,
        ranges: {
           'Cегодня': [moment(), moment()],
...
function init_SmartWizard() {
    ...
    }), $(".buttonNext").addClass("btn btn-success").on('click', function () {
        sendToDB();
    }), $(".buttonPrevious").addClass("btn btn-primary"), $(".buttonFinish").addClass("btn btn-default"))
}
        ...
        var a = function () {
            ...
            $("#datatable-buttons1").length && $("#datatable-buttons1").DataTable({
                ...
                buttons: [{
                    ...
                    {
                        text: 'Отправить СМС для револьверных вопросов',
                        className: "btn-sm",
                        action: function (e, dt, node, config) {

                            $.post("php/sendingSMS.php",
                                    {
                                        question_id: 1,
                                        simple_question: 2
                                    ...
                                    function (data, status) {
                                        alert("Успешно отправлен смс");

                                        if (data == 1) {

                                            $("#loading_page").load(location.href + " #loading_page>*", "");
...

                    {
                        ...
                        action: function (e, dt, node, config) {
                            ...
                            window.location.replace("../production/addQuestions.php");
...

                    {
                        ...
                        action: function (e, dt, node, config) {
                            ...
                            var questions_ids = '';
                            $('#datatable-buttons1').find('input[type="radio"]:checked').each(function () {

                                if ($(this).val() != " " && $(this).val() != null) {
                                    questions_ids = $(this).val();
                                }
                            ...
                            if (questions_ids.length > 0) {
                                ...
                                window.location.replace("../production/editQuestions.php?id=" + questions_ids);
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        action: function (e, dt, node, config) {
                            ...
                            window.location.replace("../production/addSimpleQuestions.php");
...

                    {
                        ...
                        action: function (e, dt, node, config) {
                            ...
                            var questions_ids = '';
                            $('#datatable-buttons2').find('input[type="radio"]:checked').each(function () {
                            ...
                            if (questions_ids.length > 0) {
                                ...
                                window.location.replace("../production/editSimpleQuestions.php?id=" + questions_ids);
...
function init_morris_charts() {
    ...
    $("#graph_donut").length && Morris.Donut({
        ...
        // document.location.href = "../production/customerDetail.php";
        window.open('../production/customerDetail.php?code=' + row.param, '_blank');
        ...
        if ($("#echart_line").length) {
            ...
            f.setOption({
                ...
                legend: {
                    x: 220,
                    y: 40,
                    data: ["Call-center","Офис продаж", "Техподдержка"]
                },
                toolbox: {
                    show: !0,
                    feature: {
                ...
                series: [
                    {
                        ...
                        data: res_channel_arr_call_center_year
                    },
                    {
                        name: "Офис продаж",
                        type: "line",
                        ...
                        data: res_channel_arr_office_year
                    },  {
                        name: "Техподдержка",
                        type: "line",
                        smooth: !0,
                        ...
                        data: res_channel_arr_help_desk_year
                    }]
            })
        }
...
if ($("#echart_stacked_bar_simple_questions").length) {

//	alert(JSON.stringify(percentage_response_rate));

    var f = echarts.init(document.getElementById("echart_stacked_bar_simple_questions"), a);
    f.setOption({
        title: {
            text: "",
            subtext: ""
...
if ($("#echart_stacked_bar_csat").length) {

//	alert(JSON.stringify(percentage_response_rate));

    var f = echarts.init(document.getElementById("echart_stacked_bar_csat"), a);
    f.setOption({
        title: {
            text: "",
            subtext: ""
        ...
        if ($("#echart_stacked_bar").length) {



            var f = echarts.init(document.getElementById("echart_stacked_bar"), a);
            f.setOption({
                title: {
                    text: "",
                    subtext: ""
        ...
        if ($("#echart_pie").length) {
            ...
            j.setOption({
                ...
                legend: {
                    ...
                    data: ["Промоутеры "+count_for_question_well_percentage ,"Нейтралы "+count_for_question_good_percentage,  "Детракторы "+count_for_question_bad_percentage]
                },
                toolbox: {
                    show: !0,
                    feature: {
                        magicType: {
                            ...
                            option: {
                                funnel: {
                                    ...
                                    width: "50%",
                                    funnelAlign: "left",
                                    max: count_for_question_total[0]
                                }
                            }
                        },
                        restore: {
                ...
                series: [{
                        ...
                        data: [
			     {
                                value: count_for_question_well[0],
                                name: "Промоутеры "+count_for_question_well_percentage
                            },

			     {
                                value: count_for_question_good[0],
                                name: "Нейтралы "+count_for_question_good_percentage
                            },
				 {
                                value: count_for_question_bad[0],
                                name: "Детракторы "+count_for_question_bad_percentage
                            }
        ...
        if ($("#echart_pie_region").length) {



            var j = echarts.init(document.getElementById("echart_pie_region"), a);
            j.setOption({
            	title:{
        ...
        if ($("#echart_csat_region").length) {



            var j = echarts.init(document.getElementById("echart_csat_region"), a);
            j.setOption({
            	title:{
                ...
                legend: {
                    ...
                    data: ["очень быстро "+bar_very_good_rate ,"быстро "+bar_good_rate,  "нормально "+bar_dont_know_rate, "медленно "+bar_bad_rate, "очень медленно "+bar_very_bad_rate]
                },
                toolbox: {
                    show: !0,
                    feature: {
                ...
                series: [{
                        ...
                        data: [
			     {
                                value: bar_very_good_value,
                                name: "очень быстро "+bar_very_good_rate
                            },

			     {
                                value: bar_good_value,
                                name: "быстро "+bar_good_rate
                            },
                            {
                                value: bar_dont_know_value,
                                name: "нормально "+bar_dont_know_rate
                            },
                            {
                                value: bar_bad_value,
                                name: "медленно "+bar_bad_rate

                            },
                            {
                                value: bar_very_bad_value,
                                name: "очень медленно "+bar_very_bad_rate
